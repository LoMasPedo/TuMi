...
import 'package:firebase_grupo15/regsitrarPedido.dart';
...
class _carritoComprasState extends State<carritoCompras>{
  ...
  Widget build(BuiltContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: carritoBar(listaPedido: widget.pedido,
        cliente: widget.cedula, negocio: widget.id),
...
class carritoBar extends statefulWidget{
  ...
  const carritoBar ({key? key?}) : super (key:key);
